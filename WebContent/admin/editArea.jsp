                ...
                <div class="col-lg-12">
                    <section class="panel">
                        ...
                        <div class="panel-body">
                            <div class="form">
                                <form class="cmxform form-horizontal" id="areaform" name="areaform"  action="<%=request.getContextPath()%>/AreaController"  method="post">
                                    <c:forEach items="${sessionScope.editlist}" var="j">
                                    <div class="form-group ">
                                     <input type="hidden" name="flag" value="update">
                                      <input type="hidden" name="id" value="${j.areaId}">
                     ...
                     <div class="form-group ">
                        ...
                        <div class="col-lg-6">
                            <select class="form-control m-bot15" name="cityselect" id="cityselect">
                            	...
                            	<c:if test="${i.cityid eq j.cityVO.cityid}">
                                	<option value="${i.cityid}" selected="selected">${i.cityname}</option>
                                </c:if>
                                <c:if test="${i.cityid ne j.cityVO.cityid }">
                        ...
                        <div class="col-sm-6">
                            <input type="text" name="areaId" id="areaId" value="${j.areaName}" class="form-control">
                        </div>
                    </div>                
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    <textarea rows="6" name="areaDesc" id="areaDesc" value="${j.areaDesc}"  class="form-control"></textarea>
                                </div>
                            </div>

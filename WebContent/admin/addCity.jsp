                ...
                <div class="col-lg-12">
                    <section class="panel">
                        ...
                        <div class="panel-body">
                            <div class="form">
             <form class="cmxform form-horizontal" action="<%=request.getContextPath()%>/CityController" method="get"  name="cityform">
                     ...
                     <div class="form-group ">
                        ...
                        <div class="col-sm-6">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    <textarea rows="6" name="cityDesc" class="form-control"></textarea>
                                </div>
                            </div>

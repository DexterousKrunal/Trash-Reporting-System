                        ...
                        <div class="adv-table editable-table ">
                            ...
                            <table class="table table-striped table-hover table-bordered" id="editable-sample">
                                ...
                                <tr class="">
                                    ...
                                    <td><a href="<%=request.getContextPath()%>/CityController?flag=edit&id=${i.cityid}">Edit</a>
                                    <a href="<%=request.getContextPath()%>/CityController?flag=delete&id=${i.cityid}">Delete</a></td>
                                </tr>
                                </c:forEach>

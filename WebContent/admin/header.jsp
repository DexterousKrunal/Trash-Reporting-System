	...
	<div class="brand">
		...
		<a href="index.html" class="logo"> <img src="img/logo.png" alt="">
		</a>
		...
		<ul class="nav top-menu">
			...
			<li class="dropdown"><a data-toggle="dropdown"
				...
				<ul class="dropdown-menu extended tasks-bar">
					<li>
						<p class="">You have 10 pending tasks</p>
					</li>
					<li><a href="#">
			...
			<li id="header_inbox_bar" class="dropdown"><a
				...
				<ul class="dropdown-menu extended inbox">
					...
					<li><a href="#"> <span class="photo"><img
								alt="avatar" src="img/avatar-mini-2.jpg"></span> <span
					...
					<li><a href="#"> <span class="photo"><img
								alt="avatar" src="img/avatar-mini-3.jpg"></span> <span
		...
		<ul class="nav pull-right top-menu">
			...
			<li class="dropdown"><a data-toggle="dropdown"
				class="dropdown-toggle" href="#"> <img alt=""
					src="img/avatar1_small.jpg"> <span class="username">John
						Doe</span> <b class="caret"></b>
			</a>
				<ul class="dropdown-menu extended logout">
					<li><a href="#"><i class=" fa fa-suitcase"></i>Profile</a></li>
					<li><a href="#"><i class="fa fa-cog"></i> Settings</a></li>
					<li><a href="?flag=logout"><i class="fa fa-key"></i> Log Out</a></li>
				</ul></li>

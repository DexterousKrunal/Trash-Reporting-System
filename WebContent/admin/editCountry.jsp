...
<body>
	...
	<div class="row">
		<div class="col-lg-12">
			...
			Manage Country <span class="tools pull-right"> <a
			...
			<div class="panel-body">
				<div class="form">
					<form class="cmxform form-horizontal " id="signupForm1"
						...
						<div class="form-group">
							...
							<div class="col-sm-6">
								<input type="text" name="cName" class="form-control" value="${j.cn}">
							</div>
						</div>
						...
						<div class="panel-body">
							<div class="form-group">
								...
								<div class="col-sm-6">
									<textarea rows="6" name="cDesc" value="${j.cd}"  class="form-control"></textarea>
								</div>
							</div>
						</div>
